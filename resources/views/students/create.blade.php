...
@section('content')
    <div class="mx-auto max-w-2xl">
        ...
        <ol class="mb-10 flex items-start justify-between">
            @foreach (['Personal', 'Contact & Address', 'Academic', 'Review'] as $index => $label)
        ...
        <form id="registration-form" action="{{ route('students.store') }}" method="POST" novalidate>
            @csrf
                ...
                <div data-step class="hidden space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <x-form-group name="program" label="Program">
                            <x-text-input name="program" placeholder="e.g. BS Information Technology" required />
                        </x-form-group>
